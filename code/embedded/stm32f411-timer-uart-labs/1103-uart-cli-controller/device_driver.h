...
extern int Uart2_Take_Line(char *line, unsigned int size);
...
extern void LED_On_Number(unsigned int led);
extern void LED_Off_Number(unsigned int led);
extern int LED_Get_State(unsigned int led);
...
extern int Key2_Get_Pressed(void);
