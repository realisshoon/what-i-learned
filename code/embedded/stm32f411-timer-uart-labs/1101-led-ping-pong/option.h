...
#define LED_TIMER_COUNTER_HZ 10000U
#define LED_TIMER_ARR_MIN    999U
#define LED_TIMER_ARR_MAX    9999U
#define LED_TIMER_ARR_STEP   500U
#define LED_TIMER_ARR_INIT   4999U
