...
module spi_slave (
    ...
    assign cs_fall      = (c_cs_n_sync[2:1] == 2'b10);  // 1 -> 0
    assign cs_rise      = (c_cs_n_sync[2:1] == 2'b01);  // 0 -> 1
    ...
    // Next logic
    // Mode0: rising sample, falling shift
    always_comb begin
        // synchronizer next
        ...
        if (cs_active) begin
            ...
            // falling edge: update next MISO bit
            if (sclk_fall) begin
