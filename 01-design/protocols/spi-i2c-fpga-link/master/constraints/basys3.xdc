...
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 PULLUP true } [get_ports {i2c_sda}];#Sch name = JB2
...
# set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports {i2c_scl}];#Sch name = JC7
# set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 PULLUP true } [get_ports {i2c_sda}];#Sch name = JC8
