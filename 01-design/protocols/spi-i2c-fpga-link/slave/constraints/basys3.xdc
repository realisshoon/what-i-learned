...
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports {spi_miso}];#Sch name = JA2
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports { spi_mosi}];#Sch name = JA3
...
# set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports dht11];#Sch name = JB4
...
##Pmod Header JC
# set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports {spi_sclk}];#Sch name = JC1
...
# set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {spi_cs_n}];#Sch name = JC4
...
##Pmod Header JXADC
# set_property -dict { PACKAGE_PIN J3 IOSTANDARD LVCMOS33 } [get_ports {i2c_scl}] ;# XA1_P
# set_property -dict { PACKAGE_PIN L3 IOSTANDARD LVCMOS33 PULLUP true } [get_ports {i2c_sda}] ;# XA2_P
